...
function get_attribute_type($type=''){
    ...
    static $_type = array(
        ...
        'gallery'      =>  array('图片集','varchar(255) NOT NUL'),
    );
...
function getGallery($path){
    ...
    $str = "";
    foreach ($paths as $v) {
        $str .= "<li class='uploadify-queue-item'>";
        $str .= "<div class='galleryinfo magnify' onclick='magnifygallery(\"" . $v['path'] . "\")'>";
        $str .= "<img src='" . $v["path"] . "'>";
        $str .= "</div>";
        $str .= "<a href='javascript:void(0);' onclick='removeGallery(this, \"id:" . $v['id'] . ";path:" . $v['path'] . "|\")'>删除该图片</a>";
        $str .= "</li>";
    }
    return $str;
}
