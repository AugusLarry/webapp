...
<div class="views">
	...
	<div class="navbar">
		<div class="navbar-inner">
			<?php if($category["name"] != 'clinic'): ?><div class="left"><a href="#" class="back link"><i class="icon icon-back"></i><span>Back</span></a></div><?php endif; ?>
	...
	<div class="pages navbar-through toolbar-through">
		<div data-page="activity" class="page">
			<style>
			...
			<div class="page-content hide-bars-on-scroll infinite-scroll" data-distance="50">
				<!--调用优惠活动文章列表-->
				<?php echo W('Category/activity');?>
				<!-- 加载提示符 -->
				<div class="infinite-scroll-preloader is-hide">
